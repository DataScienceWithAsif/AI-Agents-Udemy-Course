...
# For Maintaining Memory during interactions
...
class TrendingCompany(BaseModel):
    ...
    reason: str = Field(description="Reason, why this company is trending")

class TrendingCompanyList(BaseModel):
    """List of multiple trending companies that are in the news"""
    companies: List[TrendingCompany] = Field(description="List of companies trending in the news")  # pyright: ignore[reportUndefinedVariable]
...
class TrendingCompanyResearchList(BaseModel):
    ...
    research_list: List[TrendingCompanyResearch] = Field(description="Comprehensive research on all trending companies in the news.") # pyright: ignore[reportUndefinedVariable]
