...
class me:
    def __init__(self):
        ...
        #reader=PdfReader("E:\udemy\projects\agents\linkedin.pdf",encoding="utf-8")
        self.linkedin=""
        for page in reader.pages:
            text=page.extract_text()
            if text:
                self.linkedin+=text
        with open("E:\\udemy\\projects\\agents\\summary.txt","r",encoding="utf-8") as f:
            self.summary=f.read()
...
if __name__=="__main__":
    me=me()
    gr.ChatInterface(me.chat, type="messages").launch(share=False,debug=True)
